...
const PizzaBlock = ({id, name, types, imageUrl, price, sizes, onClickAddPizza, addedCount}) => {
  ...
  const onAddPizza = () => {
    const obj = {
      ...
      imageUrl, 
      price,
      size: availabeSizes[activeSize],
      type: availabeTypes[activeType]
    }
    // console.log(obj)
    onClickAddPizza(obj)
  };
  ...
  return (
    <div className="pizza-block">
      ...
      <div className="pizza-block__bottom">
        ...
        <Button onClick={onAddPizza} className="button--add"  >
          <svg
            width="12"
            height="12"
            viewBox="0 0 12 12"
